---
layout: post
title: Reflection on SPOT SIP
---

In our second year of study in Singapore Polytechnic (SP),
we are required to take a module called Social Innovation Project (SIP). Although I'm in a programme called Singapore Polytechnic's Outstanding Talent Programme or SPOT, this module for us is not too different from other students, except for the side benefit that there were more familiar faces in class that we had seen from previous events.
...
![concept-sketch]({{ site.baseurl }}/images/consketch.jpg)
![prototype]({{ site.baseurl }}/images/prototype.jpg)
![prototype-illustration]({{ site.baseurl }}/images/prototype-ill.png)
